...
<html>
    ...
    <body>
 	    <div class="card text-white bg-secondary mb-3" style="padding: 60px;">
	    	<div class="card-body">
	    		<form method="POST" action="NuevoRegistro" name="frm1" id="frm1">
                    @csrf
		        	<h2 class="card-title">Q-A MATRIX</h2>
		          	<p class="card-text">Registra tú usuario y contraseña</p>
                        ...
                        <br>
						<div class="form_container">            
							<input type="submit" name="" class="btn btn-success" style="font-size: 12px" value="INSERTAR DATOS">
						</div>
